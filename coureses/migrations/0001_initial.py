    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', coureses.fields.OrderField(blank=True)),
        ...
        migrations.AddField(
            model_name='course',
            name='subject',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='coureses.Subject'),
        ),
        migrations.CreateModel(
            name='Content',
            fields=[
                ...
                ('module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='coureses.Module')),
            ],
            options={
                'ordering': ['order'],
            },
